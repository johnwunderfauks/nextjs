! function(t) {
    ...
    var r = n(2),
        ...
        u = function(t, e, n) {
            var l, c, f, h = t & u.F,
                ...
                g = d ? r : p ? r[e] : (r[e] || {})[s];
            d && (n = e);
            for (l in n) c = !h && g && void 0 !== g[l], c && l in x || (f = c ? g[l] : n[l], x[l] = d && "function" != typeof g[l] ? n[l] : v && c ? o(f, r) : m && g[l] == f ? function(t) {
    ...
    ! function(e, n) {
        ...
        return function(t) {
                ...
                h = function() {
                    ...
                    return (0, s.default)(t, [{
                        ...
                        value: function(t) {
                            ...
                            this.extensions = {};
                            for (var n = 0; n < e.length; n++) this.extensions[e[n]] = c.getExtension(e[n]);
                        ...
                        value: function(t) {
                            ...
                            if (this._hasArrayInstance)
                                if (t.length)
                                    for (var n = 0; n < t.length; n++) this.drawInstance(t[n], mDrawingType);
                                else {
                                    var r = [],
                    ...
                    return (0, s.default)(t, [{
                        ...
                        value: function(t, e, n) {
                            ...
                            if (i ? (this.shaderProgram[t] = o.uniformLoc, u = o.isNumber) : (u = "uniform1i" === r || "uniform1f" === r, this.shaderProgram[t] = h.getUniformLocation(this.shaderProgram, t), u ? this.parameters.push({
                                    ...
                                    uniformLoc: this.shaderProgram[t],
                                    isNumber: u
                                }), a = this.parameters.length - 1), this.parameters[a].uniformLoc)
                    ...
                    return (0, s.default)(t, [{
                        ...
                        value: function(t) {
                            ...
                            if (this._vertexSize = t.length, this.bufferData(t, "aVertexPosition", 3, e), this._vertices = t, this._normals.length < this._vertices.length) {
                                for (var r = [], i = 0; i < t.length; i++) r.push([1, 0, 0]);
                        ...
                        value: function(t, e) {
                            if (l.default.checkExtension("ANGLE_instanced_arrays")) {
                                ...
                                for (r = 0; r < this._instancedAttributes.length; r++)
                                    ...
                                    for (var f = 0; f < t[r].length; f++) o.push(t[r][f]);
                        ...
                        value: function() {
                            for (var t = void 0, e = d.create(), n = [], r = 0; r < this._vertices.length; r++) {
                                d.set(e, 0, 0, 0);
                                for (var i = 0; i < this._faces.length; i++) t = this._faces[i], t.indices.indexOf(r) >= 0 && (e[0] += t.normal[0], e[1] += t.normal[1], e[2] += t.normal[2]);
            ...
            var r = n(24),
                ...
                l = function() {
                    var t, e = n(60)("iframe"),
                        r = o.length,
                        i = ">";
                    for (e.style.display = "none", n(116).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object</script" + i), t.close(), l = t.F; r--;) delete l[u][o[r]];
                    return l()
                };
                ...
                v = function() {
                    function t(e) {
                        ...
                        var a = [h.TEXTURE_CUBE_MAP_POSITIVE_X, h.TEXTURE_CUBE_MAP_NEGATIVE_X, h.TEXTURE_CUBE_MAP_POSITIVE_Y, h.TEXTURE_CUBE_MAP_NEGATIVE_Y, h.TEXTURE_CUBE_MAP_POSITIVE_Z, h.TEXTURE_CUBE_MAP_NEGATIVE_Z],
                            s = 1,
                            u = 0;
                        if (s = e.length / 6, this.numLevels = s, i)
                            for (var c = 0; 6 > c; c++)
                                for (var f = 0; s > f; f++) h.pixelStorei(h.UNPACK_FLIP_Y_WEBGL, !1), u = c * s + f, e[u].shape ? h.texImage2D(a[c], f, h.RGBA, e[u].shape[0], e[u].shape[1], 0, h.RGBA, h.FLOAT, e[u].data) : h.texImage2D(a[c], f, h.RGBA, h.RGBA, h.UNSIGNED_BYTE, e[u]), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_WRAP_S, this.wrapS), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_WRAP_T, this.wrapT), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_MAG_FILTER, this.magFilter), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_MIN_FILTER, this.minFilter);
                        else {
                            for (var d = 0, p = 0; 6 > p; p++) d = p * s, h.pixelStorei(h.UNPACK_FLIP_Y_WEBGL, !1), e[d].shape ? h.texImage2D(a[p], 0, h.RGBA, e[d].shape[0], e[d].shape[1], 0, h.RGBA, h.FLOAT, e[d].data) : h.texImage2D(a[p], 0, h.RGBA, h.RGBA, h.UNSIGNED_BYTE, e[d]), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_WRAP_S, this.wrapS), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_WRAP_T, this.wrapT), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_MAG_FILTER, this.magFilter), h.texParameteri(h.TEXTURE_CUBE_MAP, h.TEXTURE_MIN_FILTER, this.minFilter);
            ...
            var a = n(1),
                ...
                d = function() {
                    function t(e) {
                        ...
                        if ((0, s.default)(this, t), h = f.default.gl, n) this._texture = e;
                        else {
            ...
            t.exports = function(t, e, n, x, b, g, M) {
                ...
                if (P && (S = f(P.call(new t)), S !== Object.prototype && (c(S, A, !0), r || s(S, h) || a(S, h, m))), T && R && R.name !== v && (I = !0, D = function() {
                        return R.call(this)
                    }), r && !M || !d && !I && F[h] || a(F, h, D), u[e] = D, u[A] = m, b)
                    if (y = {
                            values: T ? D : w(v),
                            keys: g ? D : w(_),
                            entries: O
            ...
            var o = n(1),
                ...
                _ = function() {
                    ...
                    return (0, u.default)(t, [{
                        key: "_init",
                        value: function() {
                            if (this._textures = [], this._multipleTargets)
                                for (var t = 0; 4 > t; t++) {
                            ...
                            for (var a = 0; a < this._textures.length; a++) d.bindTexture(d.TEXTURE_2D, this._textures[a].texture), d.texParameteri(d.TEXTURE_2D, d.TEXTURE_MAG_FILTER, this.magFilter), d.texParameteri(d.TEXTURE_2D, d.TEXTURE_MIN_FILTER, this.minFilter), d.texParameteri(d.TEXTURE_2D, d.TEXTURE_WRAP_S, this.wrapS), d.texParameteri(d.TEXTURE_2D, d.TEXTURE_WRAP_T, this.wrapT), d.texImage2D(d.TEXTURE_2D, 0, d.RGBA, this.width, this.height, 0, d.RGBA, i, null);
                            ...
                            for (var s = 0; s < this._textures.length; s++) d.framebufferTexture2D(d.FRAMEBUFFER, d.COLOR_ATTACHMENT0 + s, d.TEXTURE_2D, this._textures[s].texture, 0);
                            if (this._multipleTargets && r.drawBuffersWEBGL([r.COLOR_ATTACHMENT0_WEBGL, r.COLOR_ATTACHMENT1_WEBGL, r.COLOR_ATTACHMENT2_WEBGL, r.COLOR_ATTACHMENT3_WEBGL]), d.framebufferTexture2D(d.FRAMEBUFFER, d.DEPTH_ATTACHMENT, d.TEXTURE_2D, this.depthTexture, 0), this.minFilter === d.LINEAR_MIPMAP_NEAREST)
                                for (var u = 0; u < this._textures.length; u++) d.bindTexture(d.TEXTURE_2D, this._textures[u].texture), d.generateMipmap(d.TEXTURE_2D);
                ...
                A = function(t) {
                    function e() {
                        ...
                        var t = [],
                            ...
                            c = void 0;
                        for (l = -a / 2; a > l; l += u)
                            for (c = -a / 2; a > c; c += u) t.push([l, c, 0]), n.push(r), r++, t.push([l, 0, c]), n.push(r), r++;
                        ...
                        value: function(t) {
                            ...
                            if (t.positions.length > e) {
                                ...
                                for (s.positions = t.positions.concat(), s.coords = t.coords.concat(), s.indices = t.indices.concat(), s.normals = t.normals.concat(); t.indices.length > 0;) {
                                    for (var u = Math.min(e, t.positions.length), l = t.indices.splice(0, u), c = [], f = [], h = [], d = void 0, p = 0, _ = 0; _ < l.length; _++) l[_] > p && (p = l[_]), d = l[_], c.push(s.positions[d]), r && f.push(s.coords[d]), n && h.push(s.normals[d]), l[_] -= a;
            ...
            function n(t, e, n, r, i, o) {
                ...
                for (var l = new Array(4), c = null, f = void 0, h = void 0, d = void 0, p = new Array(2), _ = t.length; o > 0;) {
                    ...
                    for (var m = 0; i > m; m++) e[n + 0] = c[m], e[n + 1] = c[m + i], e[n + 2] = c[m + 2 * i], e[n + 3] = c[m + 3 * i], n += 4;
                    o--
                }
            }
            ...
            var r = n(12),
                ...
                H = j && "symbol" == typeof D.iterator ? function(t) {
                ...
                Q = function(t, e) {
                    b(t);
                    for (var n, r = m(e = g(e)), i = 0, o = r.length; o > i;) W(t, n = r[i++], e[n]);
                    return t
                },
                K = function(t, e) {
                ...
                $ = function(t) {
                    for (var e, n = R(g(t)), r = [], o = 0; n.length > o;) i(V, e = n[o++]) || e == L || e == u || r.push(e);
                    return r
                },
                tt = function(t) {
                    for (var e, n = t === z, r = R(n ? U : g(t)), o = [], a = 0; r.length > a;) i(V, e = r[a++]) && (n ? i(z, e) : !0) && o.push(V[e]);
                    return o
                };
            j || (D = function() {
            ...
            for (var et = T(d.store), nt = 0; et.length > nt;) _(et[nt++]);
            a(a.S + a.F * !j, "Symbol", {
                "for": function(t) {
            ...
            }), D[k][C] || n(20)(D[k], C, D[k].valueOf), f(D, "Symbol"), f(Math, "Math", !0), f(r.JSON, "JSON", !0)
        }, function(t, e, n) {
            n(47)("asyncIterator")
        }, function(t, e, n) {
            n(47)("observable")
            ...
            i.create = function() {
                ...
                var n, r, i, o, a, s, u, l, c, f, h = SIMD.Float32x4.load(e, 0),
                ...
                var n, r, i, o, a, s, u, l, c, f, h, d, p, n = SIMD.Float32x4.load(e, 0),
                ...
                var r, i, o, a, s, u, l, c, f, h, d, p, _ = n[0],
                    v = n[1],
                    m = n[2];
                ...
                var o, a, s, u, l, c, f, h, d, p, _, v, m, x, b, g, M, y, E, S, w, A, T, I, F = i[0],
                    R = i[1],
                    D = i[2],
            ...
            function n(t) {
                ...
                if (A === f && (C += 20), D)
                    for (var U = 0; 6 > U; U++) {
                        ...
                        var z = 16;
                        k = N, L = B;
                        for (var j = Math.log(k) / Math.log(2) + 1, G = 0; j > G; G++) P = k * L * z, V.push({
                            offset: C,
                            length: P,
                            shape: [k, L]
                        }), R > G && (C += P), k = Math.floor(k / 2), L = Math.floor(L / 2)
                    } else
                        for (var G = 0; R > G; G++) P = Math.max(4, k) / 4 * Math.max(4, L) / 4 * n, V.push({
                            offset: C,
                            length: P,
                            shape: [k, L]
    ...
    var r = n(10),
        ...
        l = function() {
            var t, e = n(37)("iframe"),
                r = o.length,
                i = ">";
            for (e.style.display = "none", n(73).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object</script" + i), t.close(), l = t.F; r--;) delete l[u][o[r]];
            return l()
        };
    t.exports = Object.create || function(t, e) {
        var n;
    ...
    }), D[k][C] || n(8)(D[k], C, D[k].valueOf), f(D, "Symbol"), f(Math, "Math", !0), f(r.JSON, "JSON", !0)
}, function(t, e, n) {
    n(28)("asyncIterator")
}, function(t, e, n) {
    n(28)("observable")
    ...
    n.gui = n.gui || {}, n.utils = n.utils || {}, n.controllers = n.controllers || {}, n.dom = n.dom || {}, n.color = n.color || {}, n.utils.css = function() {
        ...
        function _(t, e, n, o) {
            ...
            return d.addClass(f, B.CLASS_CONTROLLER_ROW), d.addClass(f, typeof a.getValue()), m(t, f, a), t.__controllers.push(a), a
        }
        ...
        var I, F, R = "dg",
            ...
            B = function(t) {
                ...
                this.domElement = document.createElement("div"),
                    this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), d.addClass(this.domElement, R), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], t = t || {}, t = p.defaults(t, {
                        autoPlace: !0,
